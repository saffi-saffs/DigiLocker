...
<head>
  ...
  <title>DigiLoc-Digital Locker</title>
      ...
      <div class="row justify-content-center">
        <div class="col-xl-5 col-lg-6 pt-3 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          ...
          @auth('admin')
                ...
                @else
                <div><a href="{{ route('admin.login') }}" class="btn-get-started scrollto">Admin Login</a></div>
                @endauth
        </div>
...
<section id="services" class="services section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Services</h2>
          <p>DigiLoc -Your personal Online Locker for your documents</p>
        </div>
    ...
    <div class="container">
      ...
      <div class="copyright-wrap d-md-flex py-4">
        <div class="me-md-auto text-center text-md-start">
          <div class="copyright">
            &copy; Copyright <strong><span>DigiLoc</span></strong>. All Rights Reserved
          </div>
