...
<head>
    ...
    <title> Admin - Verified files</title>
...
<body>
    <div class="d1">
        ...
        <ul class="mt-4 list-none">
            <li>
                <a href="{{ route('admin.verifyfiles') }}" class="text-blue-600 hover:underline">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
                        <path fill-rule="evenodd" d="M15 8a.5.5 0 0 0-.5-.5H2.707l3.147-3.146a.5.5 0 1 0-.708-.708l-4 4a.5.5 0 0 0 0 .708l4 4a.5.5 0 0 0 .708-.708L2.707 8.5H14.5A.5.5 0 0 0 15 8z"/>
                    </svg>
                    <strong> Go to Verify Files </strong>
                </a>
            </li>
            <li>
        ...
        <td>
            ...
            <div class="mt-4">
                ...
                @if($file->status == "verified")
                    <a href="{{url('admin/unverify',$file->id)}}" class="btn btn-danger custom-confirm-link" data-confirmation="Are you sure you want to remove verificetion from this file?">
                        Remove Verification
                    </a>
                @endif
            </div>
